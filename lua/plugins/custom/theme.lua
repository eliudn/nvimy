    ...
    opts     = {
        ...
        overrides       = function(c)
            ...
            return {
                ...
                -- ── SNACKS DASHBOARD ──────────────────────────────────────
                SnacksDashboardHeader                    = { fg = c.red },  -- <- header ASCII art
                SnacksDashboardKey                       = { fg = c.pink }, -- tecla (f, r, g...)
                SnacksDashboardDesc                      = { fg = c.fg },   -- descripción del key
                SnacksDashboardIcon                      = { fg = c.lime }, -- icono del key
                SnacksDashboardFooter                    = { fg = "#48506a", italic = true },
            }
        end,
